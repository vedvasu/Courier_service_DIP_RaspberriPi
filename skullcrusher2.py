...
################# Function for left turn of the robot #######################33
...
####################Function for right turn of the robot ########################
...
#         shortest_path(input_array[i][0],input_array[i+1][0])
#         print '###################################',counter,len(input_array)-2
#         if counter == (len(input_array)-1):
#             print '###################',i,counter,len(input_array)-1
#             #start_delivering()
#     print i, counter
#     counter = counter+1
