...
def forward_detect_green():
	...
	b1,g1,r1 = thresh[200,40]
	b2,g2,r2 = thresh[200,600]
...
def forward_stop_at_blue():
	...
	while(1):
		...
		if (b3==255 and g3==0 and r3==0 and b4==255 and g4==0 and r4==0) or (b4==0 and g4==0 and r4==255 and b3==0 and g3==0 and r3==255):
			counter1+=1
			pt = time.clock()
			continue
	
		elif counter1>1:
			if (time.clock()-pt) > 0.51:
				PWML.stop()
				PWMR.stop()
				break
...
img = cv2.imread('CS_Test_Image3.jpg')
