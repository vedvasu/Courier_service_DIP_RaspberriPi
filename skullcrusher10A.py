...
def forward_detect_green():
	...
	b1,g1,r1 = thresh[180,40]
	b2,g2,r2 = thresh[180,600]
...
'''
* Function Name: forward_stop_at_blue
* Input: NULL
* Output: flag_traffic: if any node is red (traffic signal is encountered), flag_traffic is set 1
* Description: - This function involves video processing to check pixel value at 4 points
			   - Two points are placed at the edges of black line for line following and correction mechanism
			   - Two poimts are placed near mid point of frame to check for red and blue colour
			   - It stops after 0.5 sec clock time after detecting colour
* Example Call: flag_traffic = forward_stop_at_blue()
'''
...
def forward_stop_at_blue():
	...
	while(1):
		ret, img = cap.read()
		ret,thresh = cv2.threshold(img,77,255,cv2.THRESH_BINARY)
		b1,g1,r1 = thresh[200,175]
		b2,g2,r2 = thresh[200,465]
		b3,g3,r3 = thresh[160,320]
		b4,g4,r4 = thresh[200,320]
		...
		elif (b1==255 and g1==255 and r1==255 and b2==0 and g2==0 and r2==0) or (b1==0 and g1==0 and r1==0 and b2==255 and g2==0 and r2==0): #and b3==255 and g3==255 and r3==255:
			PWMR.ChangeDutyCycle(80)
			PWML.ChangeDutyCycle(100)

		elif (b1==0 and g1==0 and r1==0 and b2==255 and g2==255 and r2==255) or (b1==255 and g1==0 and r1==0 and b2==0 and g2==0 and r2==0): #and b3==255 and g3==255 and r3==255:
			PWMR.ChangeDutyCycle(100)
			PWML.ChangeDutyCycle(80)

		if (b3==255 and g3==0 and r3==0 and b4==255 and g4==0 and r4==0) or (b4==0 and g4==0 and r4==255 and b3==0 and g3==0 and r3==255) or (b3==0 and g3==255 and r3==0 and b4==0 and g4==255 and r4==0):
			counter1+=1
			pt = time.clock()
			continue
	
		elif counter1>1:
			if (time.clock()-pt) > 0.5:
				PWML.stop()
				PWMR.stop()
				break
...
'''
* Function Name: left_stop_at_black
* Input: NULL
* Output: NULL
* Description: - This function involves video processing to check pixel value at 1 points
			   - This point is near the left edge of frame
			   - bot rotates till the pixel value is white and stops at black
* Example Call: left_stop_at_black()
'''
...
'''
* Function Name: right_stop_at_black
* Input: NULL
* Output: NULL
* Description: - This function involves video processing to check pixel value at 1 points
			   - This point is near the right edge of frame
			   - bot rotates till the pixel value is white and stops at black
* Example Call: right_stop_at_black()
'''
...
img = cv2.imread('CS_Test_Image5.jpg')
