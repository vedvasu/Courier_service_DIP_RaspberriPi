...
def forward_stop_at_blue():
	...
	while(1):
		...
		b1,g1,r1 = thresh[200,170]
		b2,g2,r2 = thresh[200,470]
		...
		if (b3==255 and g3==0 and r3==0) or (b3==0 and g3==0 and r3==255):
			counter1+=1
			pt = time.clock()
			continue
	
		elif counter1>0:
			if (time.clock()-pt) > 0.43:
				PWML.stop()
				PWMR.stop()
				break
	#GPIO.cleanup()
